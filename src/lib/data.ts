...
export const mockEvents: Event[] = [
    { id: "EVT001", name: "Summer Music Festival", date: "2024-08-15", location: "Grand Park, New York", status: "Upcoming", imageUrl: "https://placehold.co/300x400.png?text=Summer+Fest" },
    { id: "EVT002", name: "Tech Conference 2024", date: "2024-07-20", location: "Convention Center, SF", status: "Upcoming", imageUrl: "https://placehold.co/300x400.png?text=Tech+Conf" },
    { id: "EVT003", name: "Art & Design Expo", date: "2024-06-10", location: "The Modern Gallery", status: "Completed", imageUrl: "https://placehold.co/300x400.png?text=Art+Expo" },
    { id: "EVT004", name: "Indie Film Screening", date: "2024-05-25", location: "Cinema Paradiso", status: "Completed", imageUrl: "https://placehold.co/300x400.png?text=Indie+Film" },
    { id: "EVT005", name: "Charity Gala Dinner", date: "2024-09-05", location: "The Grand Ballroom", status: "Upcoming", imageUrl: "https://placehold.co/300x400.png?text=Gala+Dinner" },
];

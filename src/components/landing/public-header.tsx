                ...
                <div className="container mx-auto px-4">
                    <div className="flex items-center justify-between h-20">
                        <Link href="#home" onClick={(e) => handleLinkClick(e, '#home')}>
                            <Image src="/images/unilife_logo.png" alt="Unilife Logo" width={120} height={32} className="object-contain" priority />
                        </Link>
            ...
            >
                <div className="h-full flex flex-col bg-gradient-to-b from-blue-400/20 to-cyan-400/20 backdrop-blur-xl border-l border-white/10">
                    <div className="flex items-center justify-between p-4 border-b border-white/10">
                         <Link href="#home" onClick={(e) => handleLinkClick(e, '#home')}>
                            <Image src="/images/unilife_logo.png" alt="Unilife Logo" width={100} height={28} className="object-contain" />
                        </Link>
